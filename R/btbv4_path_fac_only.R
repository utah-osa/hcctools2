...
#'
#' @examples
btbv4_path_fac_only<- function(df){
  df[,`:=`(
    cleaned_names =       pmap(.l=list(surg_sp_name_clean=path_sp_name_clean,
                                       surg_bp_name_clean=path_bp_name_clean,
                                       faci_sp_name_clean = faci_sp_name_clean,
                                       faci_bp_name_clean = faci_bp_name_clean,
                                       surg_sp_npi = path_sp_npi,
                                       surg_bp_npi = path_bp_npi,
